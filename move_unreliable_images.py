    ...
    for fname in os.listdir(class_path):
        ...
        try:
            ...
            if pred_class != class_folder:
                print(f"Moving {fpath} (predicted: {pred_class})")
                shutil.move(fpath, os.path.join(unreliable_class_path, fname))
